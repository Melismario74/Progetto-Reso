...
<div class="modal-header">
    ...
    <h3 id="popupFoto_label"></h3>
<?php if (DMAcl::checkPrivilege('FH_LOGISTICS'))  { ?>
<link rel="stylesheet" type="text/css" href="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/css/styles.css" />
<link rel="stylesheet" type="text/css" href="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/fancybox/jquery.fancybox-1.3.4.css" />
<?php } ?>
</div>
<div class="modal-body">
	...
	<?php if (DMAcl::checkPrivilege('FH_LOGISTICS'))  { ?>
	<script src="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/fancybox/jquery.easing-1.3.pack.js"></script>
	<script src="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
	<script src="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/webcam/webcam.js"></script>
	<script src="<?php echo DMUrl::getCurrentBaseUrl(); ?>popups/popupFoto/assets/js/script.js"></script>
	<?php } ?>
