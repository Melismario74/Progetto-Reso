        ...
        function (data) {
            ...
            if (result != false) {
                ...
                if (result.result >= 0) {
                    ...
                    //fhLogistics_printUdm(result.udm.udm_code);
...
function fhLogistics_startUDMFilling() {
    ...
    for (var i = 0; i < fhLogistics_data.udmArticlesStored.length; i++) {
        ...
        var rowHtml =
            '<tr>' +
                '<td>' + currentArticle.articleCode  + '</td>' +
...
function fhLogistics_refreshSessionArticlesTable() {
    ...
    for (var i = 0; i < fhLogistics_data.udmArticlesSession.length; i++) {
        ...
        var rowHtml =
            '<tr>' +
                '<td>' + articleSession.article_code  + '</td>' +
                '<td>' + articleSession.name  + '</td>' +
				'<td style="text-align: center; width: 75px;"><input type="text" style="width: 50px; text-align: center" id="articleSession_quantity_' + articleSession.article_id + '" value="' + articleSession.quantity + '" /></td>' +
                '<td style="text-align: center;">' +
        ...
        function (data) {
            ...
            if (result != false) {
                ...
                if (result.result >= 0) {
                    ...
                    //fhLogistics_printUdm(fhLogistics_data.udmCode);
