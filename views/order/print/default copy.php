			...
			<table width="100%" class="bordered" style="margin-top: 30px;">
				<tr>
					<td width="50%">
						...
						<div class="value">
							<b><?php echo $this->order->client_name; ?></b><br />
							<?php echo $this->order->client_address; ?><br />
							<?php echo $this->order->client_postalcode; ?> - <?php echo $this->order->client_city; ?><br />
							<?php echo $this->order->client_state; ?>
						</div>
					</td>
					<td width="50%">
		...
		<div class="footer">
			<table width="100%" class="bordered">
				<tr>
					<td>
						...
						<div class="value"><?php echo nl2br($this->order->transport_vector); ?>&nbsp;</div>
					</td>
					<td>
						<div class="label">Aspetto merce</div>
						<div class="value"><?php echo nl2br($this->order->goods_aspect); ?>&nbsp;</div>
					</td>
					<td colspan="2">
				...
				<tr>
					<td>
						...
						<div class="value"><?php echo nl2br($this->order->packages); ?>&nbsp;</div>
					</td>
					<td>
						<div class="label">Data e ora trasporto</div>
						<div class="value"><?php echo nl2br($this->order->transport_date); ?>&nbsp;</div>
					</td>
					<td colspan="2">
				...
				<tr>
					<td colspan="2">
						...
						<div class="value"><?php echo nl2br($this->order->transport_source); ?>&nbsp;</div>
					</td>
					<td colspan="2">
			...
			<table width="100%" style="font-size: 9pt; text-align: center; margin-top: 20px;">
				<tr>
					<td>
						<b>BBS SpA</b><br />
						Sede legale: Via Viazza 3043, San Cesario sul Panaro, Modena <br />
