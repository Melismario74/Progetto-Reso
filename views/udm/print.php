<?php
	...
	class DMPrintUdm extends DMPrintClass {
		...
		function execPrint($view, $template) {
			...
			$this->udm->articles = FHUdmHelper::getUdmArticles($this->udmId);
		...
		function printMultipleLabels($view, $template) {
			...
			foreach ($this->printArray as $printData) {
				...
				$printData->articles = FHUdmHelper::getUdmArticles($printData->udmId);
