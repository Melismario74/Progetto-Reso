<?php
	...
	class GlassJsonController extends DMJsonController {
		...
		**/
		...
		function jsonAggregatePackage() {
			...
			FHHelper::log("fh", "[glass.jsonAggregatePackage] Starting aggregation for $packages packages of article $articleId");
			...
			$printResult = $myPrintClass->execPrint('glass', 'default');
