<?php
	...
	class GoodJsonController extends DMJsonController {
		...
		**/
		...
		function jsonAggregatePackage() {
			...
			FHHelper::log("fh", "[good.jsonAggregatePackage] Starting aggregation for $packages packages of article $articleId");
			...
			$printResult = $myPrintClass->execPrint('good', 'default');
