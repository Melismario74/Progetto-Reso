...
; (function ($, undefined) {
    $.fn.cascadingDropdown = function (o) {
        return this.each(function () {
            ...
            function buildSelectListItems(data, textKey, valueKey, dataElement) {
            	var result = [];
            ...
            function getSelectListItems(url, ajaxData, successFn, noResultFn, dataElement) {
                $.getJSON(url, ajaxData, function (data) {
                	var myData;
                	if (dataElement == undefined) {
            			myData = data;
            		} else {
            			myData = data[dataElement];
            		}
